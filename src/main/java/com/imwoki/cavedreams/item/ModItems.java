...
public class ModItems {
    ...
    public static final Item UNTAMED_LULLADUST = new Item(new FabricItemSettings());
    public static final Item STABILIZED_LULLADUST = new Item(new FabricItemSettings());
